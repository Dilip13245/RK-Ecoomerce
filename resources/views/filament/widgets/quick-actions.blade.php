    ...
    <x-filament::section>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-3">
            ...
            <a href="{{ route('filament.admin.resources.categories.create') }}" 
               class="flex flex-col items-center p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-900/30 transition">
                ...
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Add Category</span>
            </a>
            ...
            <a href="{{ route('filament.admin.resources.product-reviews.index') }}" 
               class="flex flex-col items-center p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg hover:bg-yellow-100 dark:hover:bg-yellow-900/30 transition">
            ...
            <a href="{{ route('filament.admin.resources.help-supports.index') }}" 
               class="flex flex-col items-center p-4 bg-teal-50 dark:bg-teal-900/20 rounded-lg hover:bg-teal-100 dark:hover:bg-teal-900/30 transition">
