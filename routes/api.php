...
Route::prefix('user')->middleware(['tokencheck'])->group(function () {
    ...
    Route::prefix('products')->group(function () {
        ...
        Route::get('/new-arrivals', [\App\Http\Controllers\Api\ProductController::class, 'newArrivals']);
        Route::get('/new-offers', [\App\Http\Controllers\Api\ProductController::class, 'newOffers']);
